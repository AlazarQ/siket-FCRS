<x-app-layout>
    ...
    <x-bladewind.card>
        ...
        <form id="fyr-request-form" class="request-form" action="{{ route('settings.modeOfPayments.store') }}" method="post"
            enctype="multipart/form-data">


            <h1 class="my-2 text-4xl font-light text-green-900/80"><b>Mode of Payment</b></h1>
