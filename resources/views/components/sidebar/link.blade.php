...
@php
    $isActiveClasses =  $isActive ? 'text-white bg-green-800 shadow-lg hover:bg-green-900' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:text-gray-300 dark:hover:bg-dark-eval-2';
