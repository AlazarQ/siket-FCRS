...
@php
    ...
    switch ($variant) {
        case 'primary':
            $variantClasses = 'bg-green-800 text-white hover:bg-green-900 focus:ring-green-800';
        break;
        case 'secondary':
            $variantClasses = 'bg-white text-gray-500 hover:bg-gray-100 focus:ring-green-800 dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200';
        break;
        case 'success':
        ...
        break;
        default:
            $variantClasses = 'bg-green-700 text-white hover:bg-green-800 focus:ring-green-700';
    }
