<x-app-layout>
    ...
    <x-bladewind.card>
        ...
        <form id="fcy-request-form" class="request-form-update" action="{{ route('fcy-request.reject', $fCY_Request) }}"
            ...
            <h1 class="my-2 text-4xl font-light text-green-900/80"><b>View FCY Request - Reject (2nd)</b></h1>
            ...
            <div class="text-right">
                ...
                <x-bladewind.button id="submit-btn" has_spinner="true" color="red" can_submit="true"
                    class="mt-3">
                    Reject
                </x-bladewind.button>
            </div>
