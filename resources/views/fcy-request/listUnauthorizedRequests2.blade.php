<x-app-layout>
    ...
    <div class="container mx-auto">
        ...
        <x-bladewind::card reduce_padding="true">
            <h1 class="my-2 text-4xl font-light text-green-900/80"><b>FCy Requests - Unauthorized (2nd Authorization)</b></h1>
                            ...
                            <x-bladewind::dropmenu>
                                <x-bladewind::dropmenu-item>
                                    <x-bladewind::button size="tiny" type="secondary" icon="arrow-right">
                                        <a href="{{ route('fcy-request.showAuthReg2', $fcyRequest->id) }}" class="btn btn-secondary">Approve</a>
                                    </x-bladewind::button>
                                </x-bladewind::dropmenu-item>
                                <x-bladewind::dropmenu-item>
                                    <x-bladewind::button size="tiny" type="secondary" icon="trash">
                                        <a href="{{ route('fcy-request.showRejectReg2', $fcyRequest->id) }}" class="btn btn-warning">Reject</a>
                                    </x-bladewind::button>
                                </x-bladewind::dropmenu-item>
                            </x-bladewind::dropmenu>
                        </td>
