<x-app-layout>
    ...
    <x-bladewind.card>
        ...
        <form id="fcy-request-form" class="request-form-update" action="{{ route('fcy-request.authorize2', $fCY_Request) }}"
            method="" enctype="multipart/form-data">


            <h1 class="my-2 text-4xl font-light text-green-900/80"><b>View FCY Request - Registration (2nd Authorization)</b></h1>
            ...
            <div class="text-right">
                ...
                <x-bladewind.button id="submit-btn" has_spinner="true" color="blue" can_submit="true" icon="arrow-left"
                    class="mt-3">
                    <a href="{{ route('fcy-request.listUnauthorizedRequests') }}" class="btn btn-secondary" />
                    Back
                </x-bladewind.button>
